...
namespace B13\NewspageEditInLayout\EventListener;

/*
 * This file is part of TYPO3 CMS-based extension "newspage-page-heade3r" by b13.
 *
...
final class AddFieldsToPageLayout
{
    ...
    protected function registerDocHeaderButtons(ModuleTemplate $view): void
    {
        ...
        $button = $buttonBar
            ...
            ->setName('_savedok')
            ->setValue('1')
            ->setTitle($this->getLanguageService()->sL('LLL:EXT:newspage_page_header/Resources/Private/Language/locallang_be.xlf:layout.button.save'))
